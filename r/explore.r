...
## Copyright (c) 2013,2014 Rhea Myers <rhea@myers.studio>
##
...
## Plot birth co-ordinates on map

## Plot death co-ordinates on map

## Cluster birth co-ordinates

## Cluster death co-ordinates
